package com.camellias.stardust.common.container;
...
public class ContainerMicroFissionReactor extends Container
{
	private final TileMicroFissionReactor tileentity;
	private int energy, cookTime;
	
	public ContainerMicroFissionReactor(InventoryPlayer player, TileMicroFissionReactor tileentity) 
	{
		this.tileentity = tileentity;
		IItemHandler handler = tileentity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null);
		
		this.addSlotToContainer(new SlotItemHandler(handler, 0, 33, 33));
